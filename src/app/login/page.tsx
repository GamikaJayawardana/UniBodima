    ...
    <div className="min-h-screen bg-white flex">
      ...
      <div className="hidden lg:flex w-1/2 relative bg-slate-900 overflow-hidden items-center justify-center">
        ...
        <div className="relative z-10 p-16 flex flex-col justify-center h-full max-w-2xl text-white">
          ...
          <h2 className="text-5xl font-bold mb-6 leading-tight">Welcome back to your community.</h2>
          <p className="text-lg text-blue-100 mb-12 max-w-lg">
            Sign in to access your saved spaces, messages, and continue your housing journey.
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <div className="flex justify-between items-center mb-1.5 ml-1">
                ...
                <Link href="#" className="text-xs font-medium text-blue-600 hover:text-blue-700">Forgot password?</Link>
              </div>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-400">
