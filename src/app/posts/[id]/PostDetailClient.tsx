...
export default function PostDetailClient({ id, initialPost }: { id: string; initialPost?: any }) {
  ...
  useEffect(() => {
    ...
    // Refresh from the server (also increments the view count) even when the
    // SSR-provided initialPost is already available.
    loadPost();
  }, [id]);
              ...
              <div className="p-8 md:p-10 space-y-8 flex-grow">
                 <div>
                    ...
                    <div className="flex flex-wrap items-baseline gap-x-2.5 gap-y-1">
                       <span className="text-3xl sm:text-4xl md:text-5xl font-black text-slate-900 tracking-tighter break-words">
                          {isOffer
